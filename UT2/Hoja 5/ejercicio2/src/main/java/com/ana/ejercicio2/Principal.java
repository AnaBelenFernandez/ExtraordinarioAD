        ...
        try  
        {
            ...
            switch (opcion)
            {
                ...
                case 4:
                    //pedir el nombre
                    System.out.println("Teclea nombre de artista");
                    String artista4 = teclado.nextLine();
                    URL url4 = new URL("https://ws.audioscrobbler.com/2.0/?method=artist.getsimilar&artist=" + artista4 + "&api_key=1b69eab503a0c4b333b88b9947a33709&format=json&limit=10");
